...
{
    /**
     * @var \SprykerSdk\Sdk\Infrastructure\Builder\TaskSet\Yaml\TaskSetCommandsFactory
     */
    protected TaskSetCommandsFactory $taskSetCommandsFactory;

    /**
     * @var \SprykerSdk\Sdk\Infrastructure\Builder\TaskSet\Yaml\TaskSetPlaceholdersFactory
     */
    protected TaskSetPlaceholdersFactory $taskSetPlaceholdersFactory;

    /**
     * @var \SprykerSdk\Sdk\Infrastructure\Builder\TaskSet\Yaml\TaskSetOverrideMapFactory
     */
    ...
    /**
     * @param \SprykerSdk\Sdk\Infrastructure\Builder\TaskSet\Yaml\TaskSetCommandsFactory $taskSetCommandsFactory
     * @param \SprykerSdk\Sdk\Infrastructure\Builder\TaskSet\Yaml\TaskSetPlaceholdersFactory $taskSetPlaceholdersFactory
     * @param \SprykerSdk\Sdk\Infrastructure\Builder\TaskSet\Yaml\TaskSetOverrideMapFactory $taskSetPlaceholdersOverrideMapFactory
    ...
    public function buildTaskFromYamlTaskSet(array $taskSetConfiguration, array $taskConfigurations): TaskInterface
    {
        ...
        $existingTasks = $this->taskStorage->getTaskCollection();
