...
class CheckReadinessResponseTransfer extends AbstractTransfer
{
    ...
    {
        return [
            'is_successful' => $this->isSuccessful instanceof AbstractTransfer ? $this->isSuccessful->toArray(true,
                false) : $this->isSuccessful,
    ...
    {
        return [
            'isSuccessful' => $this->isSuccessful instanceof AbstractTransfer ? $this->isSuccessful->toArray(true,
                true) : $this->isSuccessful,
            'recipes' => $this->recipes instanceof AbstractTransfer ? $this->recipes->toArray(true,
