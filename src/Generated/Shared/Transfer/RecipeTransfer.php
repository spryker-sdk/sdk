...
class RecipeTransfer extends AbstractTransfer
{
    ...
    /**
     * @var \ArrayObject|\Generated\Shared\Transfer\CheckerMessageTransfer[]
     */
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'loaded_recipe' => $this->loadedRecipe instanceof AbstractTransfer ? $this->loadedRecipe->toArray(true,
                false) : $this->loadedRecipe,
            'checker_messages' => $this->checkerMessages instanceof AbstractTransfer ? $this->checkerMessages->toArray(true,
                false) : $this->addValuesToCollection($this->checkerMessages, true, false),
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'loadedRecipe' => $this->loadedRecipe instanceof AbstractTransfer ? $this->loadedRecipe->toArray(true,
                true) : $this->loadedRecipe,
            'checkerMessages' => $this->checkerMessages instanceof AbstractTransfer ? $this->checkerMessages->toArray(true,
                true) : $this->addValuesToCollection($this->checkerMessages, true, true),
        ];
    }
}
