...
class ManifestTransfer extends AbstractTransfer
{
    ...
    public function toArrayRecursiveNotCamelCased(): array
    {
        return [
            ...
            'locale_name' => $this->localeName instanceof AbstractTransfer ? $this->localeName->toArray(true,
                false) : $this->localeName,
        ];
    }
    ...
    public function toArrayRecursiveCamelCased(): array
    {
        return [
            ...
            'localeName' => $this->localeName instanceof AbstractTransfer ? $this->localeName->toArray(true,
                true) : $this->localeName,
        ];
    }
}
