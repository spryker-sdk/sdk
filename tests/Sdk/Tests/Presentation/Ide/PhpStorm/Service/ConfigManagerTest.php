...
namespace Sdk\Tests\Presentation\Ide\PhpStorm\Service;
...
class ConfigManagerTest extends Unit
{
    ...
    public function testCreateXmlFileShouldCreateConfigSuccessfully(): void
    {
        ...
        $executableFilePath = self::TEST_PROJECT_PATH;
        $xml = <<<XML
<?xml version="1.0"?>
...
XML;
        ...
        $this->settingRepository
            ...
            ->with('project_dir')
            ->willReturn($this->tester->createSetting('project_dir', self::TEST_PROJECT_PATH));
        ...
        $this->assertXmlStringEqualsXmlString(file_get_contents(self::CONFIG_FILE_PATH), $xml);
    }
...
XML;
    ...
    {
        parent::tearDown();
        $this->tester->rmdir(self::TEST_PROJECT_PATH);
    }
}
