...
final class Version20221115141126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , strategy VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, has_initialization BOOLEAN NOT NULL, initialization_description VARCHAR(255) DEFAULT NULL, initializer VARCHAR(255) DEFAULT NULL, setting_type VARCHAR(30) CHECK(setting_type IN (\'sdk\',\'local\',\'shared\')) NOT NULL, force_ask_value BOOLEAN NOT NULL DEFAULT 0)');
