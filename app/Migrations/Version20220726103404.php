...
final class Version20220726103404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , strategy VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, has_initialization BOOLEAN NOT NULL, initialization_description VARCHAR(255) DEFAULT NULL, initializer VARCHAR(255) DEFAULT NULL, setting_type VARCHAR(10) CHECK(setting_type IN (\'sdk\',\'local\',\'shared\')))');
