...
final class Version20220726103404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO sdk_setting (id, path, "values", strategy, type, setting_type, has_initialization, initialization_description, initializer) SELECT id, path, "values", strategy, type, (CASE WHEN is_project = true THEN "local" ELSE "sdk" END) AS setting_type , has_initialization, initialization_description, initializer FROM __temp__sdk_setting');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO sdk_setting (id, path, "values", strategy, type, is_project, has_initialization, initialization_description, initializer) SELECT id, path, "values", strategy, type, (CASE WHEN setting_type = "sdk" THEN true ELSE false END) AS is_project, has_initialization, initialization_description, initializer FROM __temp__sdk_setting');
        $this->addSql('DROP TABLE __temp__sdk_setting');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8463B8E1B548B0F ON sdk_setting (path)');
    }
}
