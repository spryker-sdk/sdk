...
final class Version20211214113051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sdk_command (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, converter_id INTEGER DEFAULT NULL, command VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL COLLATE BINARY, has_stop_on_error BOOLEAN NOT NULL, tags CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        ...
        $this->addSql('CREATE TABLE sdk_removed_events_commands (removed_event_id INTEGER NOT NULL, command_id INTEGER NOT NULL, PRIMARY KEY(removed_event_id, command_id), CONSTRAINT FK_4A58221C5CA6D57F FOREIGN KEY (removed_event_id) REFERENCES sdk_removed_event (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4A58221C33E1689A FOREIGN KEY (command_id) REFERENCES sdk_command (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE sdk_removed_events_placeholders (removed_event_id INTEGER NOT NULL, placeholder_id INTEGER NOT NULL, PRIMARY KEY(removed_event_id, placeholder_id), CONSTRAINT FK_9503214B5CA6D57F FOREIGN KEY (removed_event_id) REFERENCES sdk_removed_event (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9503214BDA75C033 FOREIGN KEY (placeholder_id) REFERENCES sdk_placeholder (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE sdk_removed_events_files (removed_event_id INTEGER NOT NULL, file_id INTEGER NOT NULL, PRIMARY KEY(removed_event_id, file_id), CONSTRAINT FK_10A392175CA6D57F FOREIGN KEY (removed_event_id) REFERENCES sdk_removed_event (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_10A3921793CB796C FOREIGN KEY (file_id) REFERENCES sdk_file (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
